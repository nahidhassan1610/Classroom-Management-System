...
<?php
    ...
    if(isset($_POST['btn'])){
        ...
        $sql = "INSERT INTO tbl_routine (day, room, time)
                VALUES ('$day', '$room_number', '$class_time')";
  ...
  <body class="image_body">
      ...
      <div class="box" >
        <div class="container">
            ...
            <div class="col-sm-12">
                <a class="btn btn-default btn-lg" data-toggle="modal" data-target="#addInfo">Add</a>
                <a href="info_view.php" class="btn btn-default btn-lg">View</a>
            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <form action="index.php" method="post">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <select class="form-control" name="room_number" required id="exampleFormControlSelect1">
                                      <option value="">Choose Room Number</option>
                                      <option value="1">401AB</option>
                                      <option value="2">402AB</option>

                                      <option value="3">501AB</option>
                                      <option value="4">502AB</option>
                                      <option value="5">503AB</option>
                                      <option value="6">504AB</option>

                                      <option value="7">601AB</option>
                                      <option value="8">602AB</option>
                                      <option value="9">603AB</option>
                                      <option value="10">604AB</option>
                                      <option value="11">605AB[LAB]</option>
                                    </select>
                                  </div>
